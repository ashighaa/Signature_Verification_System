...
show_ana = tk.Button(
    root, text="Show Analysis", font=10, command=lambda: analysis())
record_ana = tk.Button(
    root, text="Record Result", font=10, command=lambda: record())

compare_button.place(x=200, y=320)
show_ana.place(x=180, y=380)
record_ana.place(x=180, y=440)
root.mainloop()
